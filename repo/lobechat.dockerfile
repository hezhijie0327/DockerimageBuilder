...
ENV NODE_ENV="production" NODE_TLS_REJECT_UNAUTHORIZED="0" FEATURE_FLAGS="-check_updates,-welcome_suggest" HOSTNAME="0.0.0.0" PORT="3210" PROXY_URL="" ENABLE_WEBRTC_SIGNALING_SERVER="false" WEBRTC_DEBUG="false" WEBRTC_LOG_LEVEL="notice" WEBRTC_HOST="0.0.0.0" WEBRTC_PORT="3211"
