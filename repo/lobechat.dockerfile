...
ENV NODE_ENV="production" NODE_TLS_REJECT_UNAUTHORIZED="0" FEATURE_FLAGS="-check_updates,-welcome_suggest" HOSTNAME="0.0.0.0" PORT="3210" PROXY_URL=""
