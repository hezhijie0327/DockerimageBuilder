...
ENV \
    ...
    RUSTFS_ADDRESS=":9000" RUSTFS_SERVER_DOMAINS="" RUSTFS_COMPRESS_ENABLE="on" \
    RUSTFS_CONSOLE_ADDRESS=":9001" RUSTFS_CONSOLE_ENABLE="true" \    
    RUSTFS_ACCESS_KEY="rustfsadmin" RUSTFS_SECRET_KEY="rustfsadmin" \
    RUSTFS_VOLUMES="/data" \
    RUSTFS_OBS_ENVIRONMENT="production" RUSTFS_OBS_LOGGER_LEVEL="info" RUSTFS_OBS_LOG_DIRECTORY="/logs" RUSTFS_OBS_LOG_STDOUT_ENABLED="true" \
