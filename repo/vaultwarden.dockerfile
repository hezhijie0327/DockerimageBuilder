...
ENV DEBIAN_FRONTEND="noninteractive" DATA_FOLDER="/etc/vaultwarden/data" ROCKET_ADDRESS="0.0.0.0" ROCKET_PORT="8000" WEB_VAULT_ENABLED="true" WEB_VAULT_FOLDER="/opt/vaultwarden/web-vault"
