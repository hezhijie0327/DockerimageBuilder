...
export CLOUDREVE_VERSION_FIXED=""
...
function GetLatestVersion() {
    ...
    CLOUDREVE_VERSION=$(curl -s --connect-timeout 15 "https://api.github.com/repos/cloudreve/cloudreve/git/matching-refs/tags" | jq -Sr ".[].ref" | grep "^refs/tags/" | grep -v "alpha\|beta\|rc" | tail -n 1 | sed "s/refs\/tags\///")
...
function GenerateReplacements() {
    replacement_list=(
        ...
        "s/{CLOUDREVE_VERSION}/${CLOUDREVE_VERSION_FIXED:-${CLOUDREVE_VERSION}}/g"
