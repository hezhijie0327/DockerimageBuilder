...
function GetLatestVersion() {
    ...
    LOBEHUB_VERSION=$(curl -s --connect-timeout 15 "https://api.github.com/repos/lobehub/lobehub/git/matching-refs/tags" | jq -Sr ".[].ref" | grep "^refs/tags/v" | sort -V | tail -n 1 | sed "s/refs\/tags\/v//")
