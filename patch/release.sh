...
export OPENSSL_LEGACY_VERSION_FIXED=""
...
function GetLatestVersion() {
    ...
    OPENSSL_LEGACY_VERSION=$(curl -s --connect-timeout 15 "https://api.github.com/repos/openssl/openssl/git/matching-refs/tags" | jq -Sr ".[].ref" | grep -v "alpha\|beta\|pre" | grep "^refs/tags/OpenSSL\_1" | sort | tail -n 1 | sed "s/refs\/tags\/OpenSSL\_//;s/refs\/tags\/openssl\-//" | tr "_" ".")
    ...
    OPENSSL_VERSION=$(curl -s --connect-timeout 15 "https://api.github.com/repos/openssl/openssl/git/matching-refs/tags" | jq -Sr ".[].ref" | grep -v "alpha\|beta\|pre" | grep "^refs/tags/openssl\-3" | sort | tail -n 1 | sed "s/refs\/tags\/OpenSSL\_//;s/refs\/tags\/openssl\-//" | tr "_" ".")
    ...
    SMARTDNS_VERSION=$(curl -s --connect-timeout 15 "https://api.github.com/repos/pymumu/smartdns/git/matching-refs/tags" | jq -Sr ".[].ref" | grep "^refs/tags/Release" | grep -v "-" | tail -n 1 | sed "s/refs\/tags\/Release//")
...
function GenerateReplacements() {
    replacement_list=(
        ...
        "s/{OPENSSL_LEGACY_VERSION}/${OPENSSL_LEGACY_VERSION_FIXED:-${OPENSSL_LEGACY_VERSION}}/g"
